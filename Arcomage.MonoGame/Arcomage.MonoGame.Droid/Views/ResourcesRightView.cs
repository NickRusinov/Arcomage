...
namespace Arcomage.MonoGame.Droid.Views
{
    public class ResourcesRightView : View<ResourcesViewModel>
    {
        ...
        public ResourcesRightView(ContentManager contentManager, ResourcesViewModel resourcesViewModel)
            : base(resourcesViewModel, 170, 377)
        {
            ...
            {
                PositionX = 120, PositionY = 45, SizeX = 25, SizeY = 25,
            ...
            {
                PositionX = 25, PositionY = 110, SizeX = 25, SizeY = 25,
            ...
            {
                PositionX = 120, PositionY = 160, SizeX = 25, SizeY = 25,
            ...
            {
                PositionX = 25, PositionY = 225, SizeX = 25, SizeY = 25,
            ...
            {
                PositionX = 120, PositionY = 275, SizeX = 25, SizeY = 25,
            ...
            {
                PositionX = 25, PositionY = 340, SizeX = 25, SizeY = 25,
