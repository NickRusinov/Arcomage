    ...
    public class TextOutlineScript : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                TextMesh other = outline.GetComponent<TextMesh>();
                ...
                other.transform.position = transform.position + new Vector3(pixelOffset.x, pixelOffset.y, float.Epsilon);
        ...
        void LateUpdate()
        {
            ...
            for (int i = 0; i < transform.childCount; i++)
            {
                ...
                //other.transform.position = new Vector3(worldPoint.x, worldPoint.y, transform.position.z + float.Epsilon);
